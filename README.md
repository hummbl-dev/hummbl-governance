...
[![Tests](https://img.shields.io/badge/tests-2081%20collected-blue)](https://github.com/hummbl-dev/hummbl-governance/actions/workflows/ci.yml)
...
- **2081 collected tests** across package modules, as of the latest local receipt in [docs/public-claims.md](docs/public-claims.md)
...
**Current posture:** 2081 collected tests, 34 implemented primitives, 7 MCP server entry points, and zero third-party runtime dependencies. Test-count and coverage claims require current receipts; see [docs/public-claims.md](docs/public-claims.md).
