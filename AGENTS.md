...
**hummbl-governance** — AI governance frameworks, maturity models, and control catalogs. PyPI-published Python library (v1.2.2), current test inventory governed by `docs/TEST_COUNT_AUTHORITY.md`, zero third-party runtime dependencies.
