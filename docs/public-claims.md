...
| Current local test inventory is 2027 collected tests | verified-locally | `python -m pytest --collect-only -q` on 2026-07-05 collected 2027 tests from the working tree based on `ae0ef412eb9dd79fdd809841f03ec5866b85046a` | May be stated as local collection evidence. |
