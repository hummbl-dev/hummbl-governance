...
| Package-level dedicated test collection | `pytest` collection on the release candidate commit | `python -m pytest --collect-only -q tests` | `1937 tests collected` on 2026-07-03 from `0c26fe7` |
...
# 0c26fe7f9521e7eaacb012a030e1a380883b707c

python -m pytest --collect-only -q tests
# 1937 tests collected in 2.03s
