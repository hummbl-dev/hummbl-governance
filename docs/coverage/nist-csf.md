...
| GV.RM-06 | Standardized method for calculating + prioritizing risks | 🟡 Partial: standardized method for calculating + prioritizing risks | |
...
| GV.RR-03 | Workforce cybersecurity roles + responsibilities + authorities defined | 🟡 Partial: workforce-role tuples; HR is org | |
...
| GV.OV-02 | Cybersecurity risk management results reported + reviewed | ⚪ Boundary: oversight reporting | |
| GV.OV-03 | Cybersecurity risk management performance monitored + reported | 🟡 Partial: performance metrics from governance bus; review is org | |
