...
Usage::
    ...
    adapter.ingest_receipt(receipt, kernel_version="1.2.1")
...
def _receipt_to_kernel_output(receipt: Any, kernel_version: str = "1.2.1") -> dict[str, Any]:
...
class CorpusAdapter:
    ...
    def ingest_receipt(self, receipt: Any, kernel_version: str = "1.2.1") -> str | None:
